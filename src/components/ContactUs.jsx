...
const ContactUs = () => {
  return (
    <div className="max-w-[1440px] mx-auto pt-[103px] pb-[102px] lg:max-w-[680px] xl2:max-w-[1100px] xl2:pt-[100px] sm:pt-[160px] sm:pb-[149px]">
      <TextH2 className="text-center" color="secondary">
        Contact Us
      </TextH2>
      <TagLine
        color="secondary.lightGrey"
        className="tag-line w-[532px] mt-[27px] mb-[60px] mx-auto text-center sm:max-w-[265px]"
      >
      ...
      <div className="flex max-w-[1228px] mx-auto justify-between lg:flex-col-reverse lg:max-w-[600px] xl2:max-w-[1100px] sm:max-w-[378px] ">
        <div className="w-[36.89%] px-[50px] py-[52px] flex flex-col gap-[45px] form rounded-[20px] lg:w-[100%] lg:p-12 xl2:p-7 xl2:gap-[20px] sm:py-[52px] sm:mt-[78px] sm:gap-[45px]">
          <TextH3 className="text-center" color="secondary">
            Contact Us
          </TextH3>
          <input
            type="text"
        ...
        <div className="flex flex-col justify-between  pt-[29px] pb-[43px] sm:flex-col-reverse sm:pt-[15px]  sm:max-w-[358px] sm:mx-auto">
          <div className="flex items-center gap-[35px] flex-wrap justify-center sm:flex-col sm:items-start">
            <div className="sm:flex items-center">
              ...
              <TextParagraph
                color="secondary.lightGrey"
                className="common-text max-w-[313px] text-center mt-[21px] xl2:mt-[5px] sm:text-left sm:mt-0"
              >
            ...
            <div className="sm:flex items-center">
              ...
              <TextParagraph
                color="secondary.lightGrey"
                className="common-text  text-center mt-[21px] xl2:mt-[5px]"
              >
                (843) 555-0130
              </TextParagraph>
            </div>
